...
document.addEventListener('turbolinks:load', function () {
  ...
  console.log(_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions); //eliminates all connections when people disconnect but could disconnect other connections too
  ...
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    connected: function connected() {
      console.log("connected to room ".concat(room_id)); // Called when the subscription is ready for use on the server
    },
...
// Module
exports.push([module.i, "body {\n  overflow-y: hidden;\n  -ms-overflow-style: none;\n}\nbody ::-webkit-scrollbar {\n  display: none;\n}\n.chat-room {\n  height: calc(100vh - 20px);\n  overflow-y: scroll;\n}\n.chat-room #messages {\n  padding-top: 100px;\n  padding-bottom: 100px;\n}\n.chat-room .navbar {\n  overflow-y: none;\n  position: fixed;\n  background-color: white;\n  border-bottom: 1px solid #eeeeee;\n  width: 100%;\n  margin-left: -15px;\n}\n.chat-room .message {\n  min-height: 59px;\n  z-index: -1;\n}\n.chat-room .message .content-container {\n  display: inline-block;\n}\n.chat-room .message .content-container .content {\n  background-color: #eeeeee;\n  padding: 8px 16px;\n  border-radius: 20px;\n}\n.chat-room .message .content-container .author {\n  font-size: 0.78rem;\n  color: #777777;\n  margin-left: 10px;\n}\n.chat-room .message.me .content-container {\n  float: right;\n}\n.chat-room .message.me .content-container .content {\n  background-color: #007bff;\n  color: white;\n}\n.chat-room .chat-box {\n  position: fixed;\n  bottom: 20px;\n  padding: 20px;\n  width: 75%;\n  margin-left: -15px;\n  background-color: white;\n  border-top: 1px solid #eeeeee;\n}\n.chat-room .chat-box input[type=text] {\n  height: 45px;\n  font-size: 18px;\n  padding: 8px;\n}\n.chat-room .chat-box .btn {\n  height: 45px;\n}\n.card.no-outline {\n  border: none;\n}\n.room-link:hover {\n  text-decoration: none;\n}\n.room-card {\n  transition: background-color 0.5s ease;\n  border-radius: 20px;\n}\n.room-card:hover {\n  background-color: #eeeeee;\n}\n.room-card.active {\n  background-color: black;\n}\n.room-card.active .name {\n  color: white;\n}\n.room-card.active .member-count {\n  color: #e0e0e0;\n}\n.room-card .name {\n  font-weight: bold;\n  color: black;\n}\n.room-card .member-count {\n  color: #777777;\n  font-weight: light;\n}\n.rooms-sidebar {\n  border-right: 1px solid #eeeeee;\n}\n.rooms-container {\n  height: 100%;\n  overflow-y: auto;\n}", "",{"version":3,"sources":["/home/andrew/production/chat-room/app/javascript/stylesheets/application.scss","application.scss"],"names":[],"mappings":"AAAA;EACE,kBAAA;EAIA,wBAAA;ACFF;ADDE;EACE,aAAA;ACGJ;ADEA;EACE,0BAAA;EACA,kBAAA;ACCF;ADCE;EACE,kBAAA;EACA,qBAAA;ACCJ;ADEE;EACE,gBAAA;EACA,eAAA;EACA,uBAAA;EACA,gCAAA;EACA,WAAA;EACA,kBAAA;ACAJ;ADGE;EACE,gBAAA;EACA,WAAA;ACDJ;ADEI;EACE,qBAAA;ACAN;ADCI;EACA,yBAAA;EACA,iBAAA;EACA,mBAAA;ACCJ;ADCI;EACE,kBAAA;EACA,cAAA;EACA,iBAAA;ACCN;ADGI;EACE,YAAA;ACDN;ADEM;EACE,yBAAA;EACA,YAAA;ACAR;ADKE;EACE,eAAA;EACA,YAAA;EACA,aAAA;EACA,UAAA;EACA,kBAAA;EACA,uBAAA;EACA,6BAAA;ACHJ;ADII;EACE,YAAA;EACA,eAAA;EACA,YAAA;ACFN;ADII;EACE,YAAA;ACFN;ADOA;EACE,YAAA;ACJF;ADQC;EACC,qBAAA;ACLF;ADSA;EACE,sCAAA;EACA,mBAAA;ACNF;ADOE;EACE,yBAAA;ACLJ;ADOE;EACE,uBAAA;ACLJ;ADMI;EACE,YAAA;ACJN;ADMI;EACE,cAAA;ACJN;ADOE;EACE,iBAAA;EACA,YAAA;ACLJ;ADOE;EACE,cAAA;EACA,kBAAA;ACLJ;ADSA;EACE,+BAAA;ACNF;ADSA;EACE,YAAA;EACA,gBAAA;ACNF","file":"application.scss","sourcesContent":["body {\n  overflow-y: hidden;\n  ::-webkit-scrollbar {\n    display: none;\n  }\n  -ms-overflow-style: none;\n}\n\n.chat-room {\n  height: calc(100vh - 20px);\n  overflow-y: scroll;\n\n  #messages {\n    padding-top: 100px;\n    padding-bottom: 100px;\n  }\n\n  .navbar {\n    overflow-y: none;\n    position: fixed;\n    background-color: white;\n    border-bottom: 1px solid #eeeeee;\n    width: 100%;\n    margin-left: -15px;\n  }\n\n  .message {\n    min-height: 59px;\n    z-index: -1;\n    .content-container {\n      display: inline-block;\n    .content{\n    background-color: #eeeeee;\n    padding: 8px 16px;\n    border-radius: 20px;\n    }\n    .author {\n      font-size: 0.78rem;\n      color: #777777;\n      margin-left: 10px;\n    }\n  }\n  &.me {\n    .content-container {\n      float: right;\n      .content {\n        background-color: #007bff;\n        color: white;\n      }\n    }\n  }\n}\n  .chat-box {\n    position: fixed;\n    bottom: 20px;\n    padding: 20px;\n    width: 75%;\n    margin-left: -15px;\n    background-color: white;\n    border-top: 1px solid #eeeeee;\n    input[type=text] {\n      height: 45px;\n      font-size: 18px;\n      padding: 8px;\n    }\n    .btn {\n      height: 45px;\n    }\n  }\n}\n\n.card.no-outline {\n  border: none;\n}\n\n.room-link {\n &:hover{\n  text-decoration: none;\n }\n}\n\n.room-card {\n  transition: background-color 0.5s ease;\n  border-radius: 20px;\n  &:hover {\n    background-color: #eeeeee;\n  }\n  &.active {\n    background-color: black;\n    .name{\n      color: white;\n    }\n    .member-count {\n      color: #e0e0e0;\n    }\n  }\n  .name {\n    font-weight: bold;\n    color: black;\n  }\n  .member-count {\n    color: #777777;\n    font-weight: light;\n  }\n}\n\n.rooms-sidebar {\n  border-right: 1px solid #eeeeee;\n}\n\n.rooms-container {\n  height: 100%;\n  overflow-y: auto;\n}","body {\n  overflow-y: hidden;\n  -ms-overflow-style: none;\n}\nbody ::-webkit-scrollbar {\n  display: none;\n}\n\n.chat-room {\n  height: calc(100vh - 20px);\n  overflow-y: scroll;\n}\n.chat-room #messages {\n  padding-top: 100px;\n  padding-bottom: 100px;\n}\n.chat-room .navbar {\n  overflow-y: none;\n  position: fixed;\n  background-color: white;\n  border-bottom: 1px solid #eeeeee;\n  width: 100%;\n  margin-left: -15px;\n}\n.chat-room .message {\n  min-height: 59px;\n  z-index: -1;\n}\n.chat-room .message .content-container {\n  display: inline-block;\n}\n.chat-room .message .content-container .content {\n  background-color: #eeeeee;\n  padding: 8px 16px;\n  border-radius: 20px;\n}\n.chat-room .message .content-container .author {\n  font-size: 0.78rem;\n  color: #777777;\n  margin-left: 10px;\n}\n.chat-room .message.me .content-container {\n  float: right;\n}\n.chat-room .message.me .content-container .content {\n  background-color: #007bff;\n  color: white;\n}\n.chat-room .chat-box {\n  position: fixed;\n  bottom: 20px;\n  padding: 20px;\n  width: 75%;\n  margin-left: -15px;\n  background-color: white;\n  border-top: 1px solid #eeeeee;\n}\n.chat-room .chat-box input[type=text] {\n  height: 45px;\n  font-size: 18px;\n  padding: 8px;\n}\n.chat-room .chat-box .btn {\n  height: 45px;\n}\n\n.card.no-outline {\n  border: none;\n}\n\n.room-link:hover {\n  text-decoration: none;\n}\n\n.room-card {\n  transition: background-color 0.5s ease;\n  border-radius: 20px;\n}\n.room-card:hover {\n  background-color: #eeeeee;\n}\n.room-card.active {\n  background-color: black;\n}\n.room-card.active .name {\n  color: white;\n}\n.room-card.active .member-count {\n  color: #e0e0e0;\n}\n.room-card .name {\n  font-weight: bold;\n  color: black;\n}\n.room-card .member-count {\n  color: #777777;\n  font-weight: light;\n}\n\n.rooms-sidebar {\n  border-right: 1px solid #eeeeee;\n}\n\n.rooms-container {\n  height: 100%;\n  overflow-y: auto;\n}"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-ebc655ab8d2f5959ffe8.js.map